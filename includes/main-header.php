                    ...
                    <div class="dropdown dropdown-cart">
						...
						<span class="value"><?php echo $_SESSION['tp']; ?></span>
                                ...
                                <!--<div class="basket-item-count"><span
                                            class="count"><?php /*echo $_SESSION['qnty']; */?></span></div>-->
                                ...
                                <div class="cart-item product-summary">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-7">
                                            ...
                                            <h3 class="name"><a
                                                        href="index.php?page-detail"><?php echo $row['productName']; ?></a>
                                            </h3>
                                            <div class="price">
                                                &dollar;<?php echo($row['productPrice'] + $row['shippingCharge']); ?>
                                ...
                                <div class="clearfix cart-total">
                                    <div class="pull-right">
                                        ...
                                        <span class="text">Total :</span><span
                                                class='price'>&dollar;<?php echo $_SESSION['tp'] = "$totalprice" . ".00"; ?></span>

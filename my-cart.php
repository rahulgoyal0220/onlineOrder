                ...
                <div class="col-md-12 col-sm-12 shopping-cart-table ">
                    <div class="table-responsive">
                        <form name="cart" method="post">
							...
							<span class="">
								<a href="index.php"
                                   class="btn btn-upper btn-primary outer-left-xs">Continue Ordering</a>
...
*/
								...
								<?php /*} */
                                            ...
                                            <td class="cart-product-sub-total"><span class="cart-sub-total-price">&dollar; <?php echo $row['productPrice']; ?>
                                                    .00</span></td>
                                            <!--<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php /*echo "Rs"." ".$row['shippingCharge']; */
                                            ?>.00</span></td>-->

                                            <td class="cart-product-grand-total"><span class="cart-grand-total-price">&dollar; <?php echo($_SESSION['cart'][$row['id']]['quantity'] * $row['productPrice'] + $row['shippingCharge']); ?>
                                                    .00</span></td>
                                        </tr>
